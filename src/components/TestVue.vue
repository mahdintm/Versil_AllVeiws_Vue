<template>
    <div id="LoginBoxMenu" class="LoginBoxMenu">
        <div class="app-content content" style="padding: 0; margin-left: 0;">
                            ...
                            <div class="card mb-0">
                                <div class="card-body">
                                    <a href="index.html" class="brand-logo">
                                        ...
                                        <h2 class="brand-text ms-1">Versil</h2>
                                    </a>

                                    <h4 class="card-title mb-1">Welcome to Versil Game! 👋</h4>
...
@import url('../assets/css/themes/bordered-layout.min.css');
@import url('../assets/css/themes/dark-layout.min.css');
@import url('../assets/css/themes/semi-dark-layout.min.css');
@import url('../assets/css/core/menu/menu-types/vertical-menu.min.css');
@import url('../assets/css/plugins/forms/form-validation.css');
@import url('../assets/css/pages/authentication.css');
